...
function StartPageContent() {
  ...
  if (showIntake) {
    const initialIdea = searchParams.get('idea') || undefined;
    return (
...
export default function StartPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-black via-dark to-black flex items-center justify-center">
